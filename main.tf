...
module "role_definitions" {
  source           = "git::https://github.com/AeternaModules/azurerm_role_definition.git?ref=v5.0.0"
  role_definitions = local.role_definitions
}

module "role_management_policies" {
  source                   = "git::https://github.com/AeternaModules/azurerm_role_management_policy.git?ref=v5.0.0"
